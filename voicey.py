...
wavfile.write("./output/outputSignal1.wav",samplerate_list[0],x1)
wavfile.write("./output/outputSignal2.wav",samplerate_list[1],x2)
wavfile.write("./output/outputSignal3.wav",samplerate_list[2],x3)
